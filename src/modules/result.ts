...
export class Result<S, P, C> {
     ...
     *
     * @returns {C | null} The content generated by the action, or null if the action failed.
     */
    get content(): C | null {
     ...
     *
     * @returns {Action<P, S, C>} The action that generated this result.
     */
     ...
     *
     * @returns {S | null} The state after the action, or null if the action did not alter the state.
     */
